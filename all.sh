...
TEMPLATE_LOCATION="https://github.com/Lu270087106/3line-colab-sd"
...
do
    ...
    case $key in
        ...
        *)
        ...
        echo "-l, --template-location      Location of the template repo or local directory (default: https://github.com/Lu270087106/3line-colab-sd)"
